...
export default function ProviderRegisterPlaceholder() {
  return (
    <div>
      <h1 className="text-2xl font-semibold text-slate-900">Provider registration</h1>
      <p className="mt-2 text-sm text-slate-600">
        The full provider wizard arrives in Sub-phase 1B.
      </p>
      <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm">
        <p className="font-medium text-slate-800">Test provider</p>
        <p className="text-slate-600">carepartners@shiftify.local / Password@123</p>
      </div>
