          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20, width: '100%', maxWidth: 860 }}>
            {plans.map((plan) => (
              ...
              >
                ...
                <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--clr-text)', marginBottom: 6 }}>{plan.label ?? plan.name}</div>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 20 }}>
                  ...
                  <span style={{ fontSize: 13, color: 'var(--clr-muted)' }}>{plan.period ?? '/mo'}</span>
                </div>
