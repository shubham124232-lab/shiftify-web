...
const actions: Action[] = [
  {
    id: 'emergency', Icon: FiAlertTriangle,
    label: '24 / 7 Live',
...
function Blobs({ sm = false }: { sm?: boolean }) {
  return (
    <>
        ...
        <div className="qa-bento fade-up">
          ...
          <a href={emergency.href} className="qa-card qa-card-tall" aria-label={emergency.title}>
            <div className="qa-img-area" style={{ background: emergency.gradient }}>
              ...
              <div className="qa-big-icon-wrap" style={{ boxShadow: `0 0 40px ${emergency.iconGlow}` }}>
                <emergency.Icon size={52} color="#fff" strokeWidth={1.5} aria-hidden="true" />
              </div>
            ...
            <div className="qa-content">
              ...
              <div className="qa-arrow"><FiArrowRight size={20} aria-hidden="true" /></div>
            </div>
          </a>
          ...
          <a href={find.href} className="qa-card qa-card-wide" aria-label={find.title}>
            <div className="qa-img-area" style={{ background: find.gradient }}>
              ...
              <div className="qa-big-icon-wrap" style={{ boxShadow: `0 0 40px ${find.iconGlow}` }}>
                <find.Icon size={44} color="#fff" strokeWidth={1.5} aria-hidden="true" />
              </div>
            </div>
            <div className="qa-content">
              <h3 className="qa-card-title">{find.title}</h3>
              <p className="qa-card-desc">{find.desc}</p>
              <div className="qa-arrow"><FiArrowRight size={18} aria-hidden="true" /></div>
            </div>
          </a>
          ...
          {smActions.map((action) => (
            <a key={action.id} href={action.href} className="qa-card qa-card-sm" aria-label={action.title}>
              <div className="qa-img-area qa-img-sm" style={{ background: action.gradient }}>
                ...
                <div className="qa-big-icon-wrap qa-icon-sm" style={{ boxShadow: `0 0 28px ${action.iconGlow}` }}>
                  <action.Icon size={32} color="#fff" strokeWidth={1.5} aria-hidden="true" />
                </div>
              </div>
              <div className="qa-content qa-content-sm">
                <h3 className="qa-card-title">{action.title}</h3>
                <p className="qa-card-desc">{action.desc}</p>
                <div className="qa-arrow"><FiArrowRight size={16} aria-hidden="true" /></div>
              </div>
            </a>
          ))}
