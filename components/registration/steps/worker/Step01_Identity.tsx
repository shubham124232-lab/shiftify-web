  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 8 }}>
          ...
          <div style={{
            ...
            background: avatarUrl ? 'transparent' : 'rgba(79,70,229,0.1)',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 12 }}>
        <div>
          <label htmlFor="suburb" style={labelStyle}>Suburb <span style={{ color: '#ef4444' }}>*</span></label>
          <input id="suburb" {...register('suburb')} placeholder="e.g. Bondi" style={{
            ...inputStyle, borderColor: errors.suburb ? '#ef4444' : 'var(--clr-border)',
          }} />
          {errors.suburb && <p style={{ fontSize: 12, color: '#ef4444', marginTop: 3 }}>{errors.suburb.message as string}</p>}
        </div>
        <div style={{ minWidth: 100 }}>
          <label htmlFor="state" style={labelStyle}>State <span style={{ color: '#ef4444' }}>*</span></label>
          ...
          {GENDERS.map(g => {
            ...
            return (
              <label key={g} style={{
                ...
                background: current === g ? 'rgba(79,70,229,0.07)' : '#fff',
                fontSize: 12, fontWeight: 500, color: current === g ? 'var(--clr-primary)' : 'var(--clr-text)',
              }}>
