  ...
  participant: [
    {
      ...
      desc: 'Tell us about your support needs, NDIS plan details, and location in minutes.',
    },
    {
      step: 2, Icon: FiSearch,
      title: 'Search & Browse',
      desc: 'Find verified workers filtered by service type, distance, availability, and reviews.',
    },
    {
      step: 3, Icon: FiMessageSquare,
      title: 'Connect & Book',
      desc: 'Message workers directly, agree on details, and confirm shifts securely in-app.',
    },
    {
      step: 4, Icon: FiCheckCircle,
      title: 'Get Support',
      desc: 'Your worker arrives, delivers care, and you rate the experience. Simple as that.',
    },
  ],
  worker: [
    {
      step: 1, Icon: FiShield,
      title: 'Sign Up & Verify',
      desc: 'Complete your profile, upload qualifications, and pass our background check.',
    },
    {
      step: 2, Icon: FiCalendar,
      title: 'Set Your Schedule',
      desc: 'Choose when and where you work. Full-time, part-time, or emergency shifts — your call.',
    },
    {
      step: 3, Icon: FiZap,
      title: 'Get Matched',
      desc: 'Participants find you via search or Shiftify matches you to urgent nearby requests.',
    },
    {
      step: 4, Icon: FiDollarSign,
      title: 'Deliver & Earn',
      desc: 'Complete shifts, get 5-star reviews, and receive fast, secure NDIS-compliant payments.',
    },
  ],
};
      ...
      <div className="container-xl">
        ...
        <div className="text-center mb-5 fade-up">
          ...
          <p className="section-sub">
            Two journeys, one simple platform. See how Shiftify works for you.
          </p>
        </div>

        {/* ── Tab Toggle ── */}
        <div className="d-flex justify-content-center mb-5 fade-up">
          <div role="tablist" aria-label="User type" className="hiw-tab-group">
            {[
              { key: 'participant', label: 'I Need Support', Icon: FiUserCheck },
              { key: 'worker',      label: 'I Give Support', Icon: FiUsers },
            ].map(({ key, label, Icon }) => (
              <button
                key={key}
                role="tab"
        ...
        <div className="row g-4 align-items-stretch">
          ...
          <div className="col-lg-7">
            <div
              id={`tab-panel-${tab}`}
              role="tabpanel"
              aria-label={tab === 'participant' ? 'Participant steps' : 'Worker steps'}
            >
              <div className="row g-3">
                {flows[tab].map((step, idx) => (
                  <div key={step.step} className="col-12 col-sm-6 fade-up">
              ...
              <div className="mt-4 fade-up">
                ...
                >
                  ...
                  <FiArrowRight className="ms-2" aria-hidden="true" />
                </a>
              </div>
            </div>
          </div>
