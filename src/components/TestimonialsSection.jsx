...
const testimonials = [
  {
    name: 'Deborah M.',
    role: 'NDIS Participant · Melbourne, VIC',
    initials: 'DM',
    color: '#C2185B',
    stars: 5,
    quote:
      'My carer cancelled at 9pm and I panicked. Within 6 minutes of posting on Shiftify, a verified worker confirmed. Honestly a lifesaver — I don\'t know what I would have done without this platform.',
    tag: 'Emergency Support',
  },
  {
    name: 'Rachel T.',
    role: 'Support Worker · Sydney, NSW',
    initials: 'RT',
    color: '#7C3AED',
    stars: 5,
    quote:
      'I went from zero clients to full-time hours in 3 weeks. The platform is so professional and NDIS-compliant invoicing has saved me hours every week. I\'ve referred 4 of my colleagues already.',
    tag: 'Worker Experience',
  },
  {
    name: 'James & Patricia O.',
    role: 'Carers of NDIS Participant · Brisbane, QLD',
    initials: 'JP',
    color: '#0D9488',
    stars: 5,
    quote:
      'We care for our son who has complex needs. Shiftify gives us peace of mind — we can see worker credentials, ratings, and insurance upfront. The emergency feature has saved us multiple times.',
    tag: 'Family Carers',
  },
  {
    name: 'Sandra K.',
    role: 'Support Coordinator · Perth, WA',
    initials: 'SK',
    color: '#1D4ED8',
    stars: 5,
    quote:
      'I coordinate support for 40+ participants. Shiftify\'s multi-participant dashboard has cut my admin time by 60%. When a gap appears, I fill it in minutes — not days.',
    tag: 'Coordinator',
  },
];
    ...
    <section id="testimonials" className="section-py testi-section" aria-labelledby="testi-heading">
      <div className="container-xl">
        ...
        >
          ...
          {/* Card area — single active card with fade+slide */}
          <div className="testi-card-area" aria-live="polite" aria-atomic="true">
            <div key={active} className={`testi-card-v2 testi-in-${animDir}`}>
              ...
              {/* Large quote mark */}
              <div className="testi-quote-mark" aria-hidden="true" style={{ color: `${t.color}25` }}></div>
              ...
              <div className="testi-person">
                ...
                {/* Verified badge */}
                <div className="testi-verified ms-auto">
                  <i className="bi bi-patch-check-fill" aria-hidden="true" style={{ color: '#10B981' }}></i>
                  <span>Verified</span>
                </div>
              </div>
